...
This homework set gives you practice designing models to address some of the challenges we have read about that arise in multi-variable regression models, such as multicollinearity, collider bias, post-treatment bias, and confounding variables, as well as using tools such as entropy, or information metrics and regularization to avoid these biases and identify the best-performing model among several different statistical models.
...
You can download a PDF copy of the exercises from chapters 6--7 of _Statistical Rethinking_ from
[`https://ees5891.jgilligan.org/files/homework_docs/McElreath-Ch-6-7-homework.pdf`](/files/homework_docs/McElreath-Ch-6-7-homework.pdf "Chapter 6-7 homework")
