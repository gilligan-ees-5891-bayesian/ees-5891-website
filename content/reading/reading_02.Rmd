...
* $P(D)$ is the _evidence_ (the book doesn't use this name, but it's pretty standard in Bayesian statistics): It's the probability that you'd observe data $D$ regardless what the value of $a$ is.
...
The book then gives a practical example of Bayesian updating, in which you estimate the proportion of the earth that's covered by water by repeatedly tossing a globe in the air and catching it, and updating your estimate of the proportion based on whether your index finger rests on water or land when you catch it.
