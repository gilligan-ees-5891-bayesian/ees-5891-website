...
\newcommand{\Classroom}{Classroom SC5737 (the Jewell Room)}
...
Professor of Climate \& Environmental Studies}
...
\newcommand{\ProfOfficeHours}{Office Hours:
  Tuesday 1:30--2:30, Wednesday 1:30--3:00,
	or by appointment.%
	} % TODO: Office Hours
...
{\href{https://github.com/rmcelreath/stat_rethinking_2024}%
  {\nolinkurl{github.com/rmcelreath/stat_rethinking_2024}}%
}%
\newcommand{\McElreathYouTubePlaylistURL}%
