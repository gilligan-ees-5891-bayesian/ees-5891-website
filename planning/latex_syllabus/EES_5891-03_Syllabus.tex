...
Tue., & Sep. &   6 & Geocentric Models & \emph{McElreath\/} Ch.~4 ("Geocentric Models") &  \\ 
   \midrule
Thu., & Sep. &   8 & R Review & No reading &  \\ 
   \midrule
Tue., & Sep. &  13 & Many variables (part 1) & \emph{McElreath\/} Ch.~5 ("The Many Variables and The Superfluous Waffles"), section 5.1 pp.~123--144 &  \\ 
   \midrule
Thu., & Sep. &  15 & Many variables (part 2) & \emph{McElreath\/} Ch.~5 ("The Many Variables and The Superfluous Waffles"), sections 5.2-5.4 pp.~144--158 &  \\ 
   \midrule
Tue., & Sep. &  20 & Designing statistical models & \emph{McElreath\/} Ch.~6 ("The Haunted DAG \& The Causal Terror") &  \\ 
   \midrule
Thu., & Sep. &  22 & Regularization & \emph{McElreath\/} Ch.~7 ("Ulysses' Compass") &  \\ 
   \midrule
Tue., & Sep. &  27 & Interactions & \emph{McElreath\/} Ch.~8 ("Conditional Manatees") &  \\ 
   \midrule
Thu., & Sep. &  29 & Monte Carlo sampling & \emph{McElreath\/} Ch.~9 ("Markov Chain Monte Carlo") sections 9.1--9.3 &  \\ 
   \midrule
Tue., & Oct. &   4 & Monte Carlo Software & \emph{McElreath\/} Ch.~9 ("Markov Chain Monte Carlo") sections 9.4--9.5 &  \\ 
   \midrule
Thu., & Oct. &   6 & Generalized linear models & \emph{McElreath\/} Ch.~10 ("Big Entropy and the Generalized Linear Model") sections 10.1--10.2.1 &  \\ 
   \midrule
Tue., & Oct. &  11 & Generalized linear models & \emph{McElreath\/} Ch.~10 ("Big Entropy and the Generalized Linear Model") sections 10.2--10.4 &  \\ 
   \midrule
...
\begin{tabular}{l@{~}c@{~}r>{\raggedright}m{2.6in}>{\centering}m{2in}c}
  ...
  \multicolumn{3}{c}{\bfseries Date} & \multicolumn{1}{c}{\bfseries Topic} &\multicolumn{1}{c}{\bfseries Reading} &\\
 \midrule
Tue., & Oct. &  18 & Discussion of student projects & No reading &  \\ 
   \midrule
Thu., & Oct. &  20 & Discrete statistical models & \emph{McElreath\/} Ch.~11 ("God Spiked the Integers") &  \\ 
   \midrule
Tue., & Oct. &  25 & Mixture models & \emph{McElreath\/} Ch.~12 ("Monsters and Mixtures") &  \\ 
   \midrule
Thu., & Oct. &  27 & Multilevel models & \emph{McElreath\/} Ch.~13 ("Models with Memory") &  \\ 
   \midrule
Tue., & Nov. &   1 & Multilevel models, part 2 & \emph{McElreath\/} Ch.~13 ("Models with Memory") &  \\ 
   \midrule
Thu., & Nov. &   3 & More multilevel models & \emph{McElreath\/} Ch.~14 ("Adventures in Covariance") &  \\ 
   \midrule
Tue., & Nov. &   8 & Messy data & \emph{McElreath\/} Ch.~15 ("Missing Data and Other Opportunities") &  \\ 
   \midrule
Thu., & Nov. &  10 & Review of Bayesian Regression & No reading &  \\ 
   \midrule
Tue., & Nov. &  15 & Discussion of projects & No reading &  \\ 
   \midrule
Thu., & Nov. &  17 & Generalized Linear Madness & \emph{McElreath\/} Ch.~16 ("Generalized Linear Madness") sections 16.1--16.2 &  \\ 
   \midrule
Tue., & Nov. &  22 & \multicolumn{2}{l}{\multirow{3}{*}{\bfseries\scshape\Large Thanksgiving Break}} & \\% & No reading &  \\ 
  Thu., & Nov. &  24 &  & No reading &  \\ 
   \midrule
Tue., & Nov. &  29 & Differential Equations & \emph{McElreath\/} Ch.~16 ("Generalized Linear Madness") sections 16.3---16.5 &  \\ 
   \midrule
